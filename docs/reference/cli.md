...
| `--model-tier` | `small` | unset | Request portable routine-work capacity without pinning an agent. Resolves after final agent choice to Haiku, Luna/high, or Grok 4.6. Mutually exclusive with `--model` and `--effort`. |
