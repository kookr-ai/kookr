...
| `ops-status.json` | ops-status writer (issue #1995) | Edge-triggered last-known-good ops card (ready degrade, dead-man fire, pipeline starvation fire, SAFE MODE engage): sha, hungSuspect count, data-dir free space, safeMode, recent critical edges. Read-only / no secrets. Written atomically; best-effort on disk-full. | Keep for post-hoc diagnosis when Discord/pages are down. |
