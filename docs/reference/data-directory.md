...
| `contribution-ledger.jsonl` | OSS contribution gate | Append-only contribution history (rate-limit authority). | Keep for rate-limiting, deduplication, and audit history. Never rewritten by oss-attempt retention prune. |
