...
- Anomaly detection (V1 rule-based): `needs_input`, `permission_blocked`, `repeated_error`, plus liveness anomalies (`stale_agent`, `hook_disconnected`, `hook_missing`, `backend_unreachable`, `api_error`, `merge_conflict`)
