...
- **Deploy gap:** fires before the script/placement record `missing_playbook`; with default `manual` catch-up they are recoverable via Run Now inside the 24h window.
