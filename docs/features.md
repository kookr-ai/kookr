...
| F4.12 | **First-launch recovery guidance** | The onboarding tour connects the Launch flow to setup recovery: `pnpm run doctor`, missing agent binary/auth checks, launch-preflight recommendations, and the dev/prod port split. |
