 ...
 * Codex sessions started outside Kookr. Surfaced as a labeled card alongside
 * the Codex aggregate so cross-agent spend totals remain truthful without
 * polluting per-playbook attribution
 ...
 *     is a complete picture or a known-incomplete lower bound. The R17 R17
