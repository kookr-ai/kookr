...
const AGENT_PROVIDER_PRESENTATION: Record<AgentType, AgentProviderPresentation> = {
  ...
  // Grok Build (xAI). Experimental (issue #1339 Phase 1). Placeholder "X" glyph
  // pending a licensed xAI brand asset; renders as currentColor like the others.
  'grok-build': {
    label: 'Grok Build',
    provider: 'xAI',
    iconPath: 'M3 3h3l6 8 6-8h3l-7.5 9L21 21h-3l-6-8-6 8H3l7.5-9z',
  },
};
