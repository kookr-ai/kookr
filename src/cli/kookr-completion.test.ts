...
describe('renderCompletion', () => {
  it('renders a bash completion with root commands, subcommands, and flags', () => {
    ...
    expect(script).toContain('spawn signal issue doctor status logs command ralph drain resume maintenance lesson pr-checklist push completion');
    expect(script).toContain('compgen -W "spawn signal issue doctor status logs command ralph drain resume maintenance lesson pr-checklist push completion -h --help -v --version"');
  ...
  it('renders a zsh completion with root commands, subcommands, and flags', () => {
    ...
    expect(script).toContain('root_commands=(spawn signal issue doctor status logs command ralph drain resume maintenance lesson pr-checklist push completion)');
