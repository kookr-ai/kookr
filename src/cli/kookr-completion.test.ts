...
describe('renderCompletion', () => {
  it('renders a bash completion with root commands, subcommands, and flags', () => {
    ...
    expect(script).toContain('spawn stop abort signal issue doctor status ops github logs command ralph schedule drain resume orchestration migrate maintenance lesson effort-split emission value-density queue-feeder retro-verify reflect pr-checklist context-pack signal-emit push completion');
    expect(script).toContain('compgen -W "spawn stop abort signal issue doctor status ops github logs command ralph schedule drain resume orchestration migrate maintenance lesson effort-split emission value-density queue-feeder retro-verify reflect pr-checklist context-pack signal-emit push completion -h --help -v --version"');
  ...
  it('renders a zsh completion with root commands, subcommands, and flags', () => {
    ...
    expect(script).toContain('root_commands=(spawn stop abort signal issue doctor status ops github logs command ralph schedule drain resume orchestration migrate maintenance lesson effort-split emission value-density queue-feeder retro-verify reflect pr-checklist context-pack signal-emit push completion)');
