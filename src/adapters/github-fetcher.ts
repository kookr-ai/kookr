...
import { classifyGitHubRateLimit, execGh, ghErrorStdout, spawnGhWithStdin } from './gh-cli-transport.js';

const execFile = promisify(execFileCb);

// Re-exported so existing importers of the domain fetcher keep resolving this
// symbol after the transport extraction (issue #2820).
export { classifyGitHubRateLimit } from './gh-cli-transport.js';
