  ...
  test('parses valid threshold values', () => {
    expect(
      readOperationalAlertConfigFromEnv({
        ...
        KOOKR_ALERT_PROVIDER_FALLBACK_SUBSTITUTIONS: '8',
        KOOKR_ALERT_PROVIDER_FALLBACK_WINDOW_MS: '900000',
        KOOKR_ALERT_PROVIDER_PAUSED_MS: '120000',
      ...
      providerFallbackSubstitutions: 8,
      providerFallbackWindowMs: 900_000,
      providerPausedMs: 120_000,
      sustainSamples: 5,
    });
  });
