...
- **After rebuilding:** run `node scripts/smoke-codex-code-mode.mjs` and restart any Codex sessions that were already running. Use `pnpm prod:update` only after the Kookr change is committed, pushed, and merged.
