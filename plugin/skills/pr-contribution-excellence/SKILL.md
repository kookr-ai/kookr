...
### 1. Description Structure by PR Type
...
### 2. Behavioral Risk Drives Review Effort, Not Line Count
...
### 3. Scope Discipline Is the #1 External Contributor Concern
...
### 4. Iterative Bot Self-Review Before Human Review
...
### 5. Transparency About Testing Limitations Builds Trust
...
### 6. "Does Not Change Behavior" Is a Reviewer Accelerator
...
### 7. Frame Removals as Eliminating Misleading Behavior
...
### 8. Balanced Review Response: Defend and Concede Appropriately
...
### 9. Proactive Debugging Narratives Earn Goodwill
...
### 10. Root Cause Over Symptom Fix
...
### 11. Match Existing Patterns to Reduce Review Burden
...
### 12. Trust Tiers Determine Review Speed
...
### 13. Cut Scope to Unblock Merges
...
### 14. Show the Bug Inline in Descriptions
...
### 15. Handle Setbacks and Rejections Gracefully
...
### 16. Exact Verification Commands Are Table Stakes
...
### 17. Screenshots for CLI/System-Level Changes
...
### 18. Follow-Up Sections De-Risk Large Changes
...
### 19. The Prep-Work + Execution PR Pair
...
### 20. Cross-Boundary Cleanup Must Be Atomic

### 21. In Bot-Gated Repos, Process Compliance Comes Before Code Quality
...
### 22. Do Not Copy Trusted-Insider Shortcut Patterns As An External Contributor
...
### 21. Process Compliance Before Code Quality
...
### 22. Description Brevity Scales with Change Size
...
### 23. Claim the Issue Before Writing Any Code
...
### 24. Subtool Changes Go to Subtool Repos
...
### 25. Use Project-Specific Formatting Tools
...
### 26. Revert PRs Need Empathy and Structure
...
### 27. Automated/Bulk PRs Are Unwelcome
...
### 28. Follow Up on Maintainer Suggestions
...
### 29. Survive Stale Bots Through Persistence
...
### 30. Search for Duplicate PRs AND the Target Branch Before Submitting
...
### 31. Squash-Merge Repos: PR Title IS the Commit Message
...
### 32. Before/After Visual Evidence Accelerates Review
...
### 33. Expect Both Bot and Human Review
...
### 34. Feature Toggle / Feature Gate Discipline in Large Projects
...
### 35. Self-Annotate Critical Diff Lines
...
### 36. Split Cross-Layer Changes into Paired PRs
...
### 37. Link to External Evidence When Correcting Documented Drift
...
### 38. Batch-Address All Review Comments in One Session
...
### 39. Number Stacked PRs with "(1/N)" Convention
...
### 40. Document Design Tradeoffs in "Implementation Notes"
...
### 41. Show Migration Evidence for Every Supported Platform
...
### 42. Over-Test to Eliminate Review Comments
...
### 43. Close Superseded PRs with Thread Context
...
### 44. Get Design Alignment Before Coding Non-Trivial Changes
...
### 45. Fix Regression Side-Effects In-PR
...
### 46. Stabilization/Mechanical PRs Are High-Confidence Entry Points
...
### 47. CC Domain Experts Alongside Assigned Reviewers
...
### 48. Stale CI = Abandoned PR in High-Velocity Repos
...
### 49. Bot-Delegated Review Culture
...
### 50. Verify "Unnecessary" Code Before Removing It
...
### 51. Get Policy Buy-In Before Behavioral or Architecture-Level Changes
...
### 52. Build a "Pattern Franchise" for Fast Review
...
### 53. Parity Fixes Are Low-Friction Entry Points
...
### 54. CI Responsiveness > First-Push Perfection
...
### 55. In Template-Gated Repos, Equivalent Content Does Not Count As Compliance
...
### 56. Eligibility Is Not Maintainer Priority In Stale-Bot Repos
...
### 57. Clean Branch History Is A Reviewability Signal
...
### 67. Use Hardware-Normalized Metrics for Performance PRs
...
### 68. Hardware-Owner Reviewers Substitute for Automated CI
...
### 100. Before/After Examples Are the Strongest Bug-Fix Description Pattern
...
### 101. Include Production Error Frequency to Add Urgency
...
### 102. You Can Argue With Bots Using Design-Intent Reasoning
...
### 9. Rework After Regression, Don't Abandon
...
### 10. Split Mechanical Changes from Controversial Decisions
...
### 8. AI-Generated Code Without Manual Review
...
### 9. Rephrasing Reviewer-Provided Wording
...
### 10. Sloppy Commit Messages as an External Contributor
...
### 11. Large Features as First Contributions
...
### 12. Self-Filing Issues to Satisfy Process
...
### 13. Massive PRs Without Description
...
### 14. Pinging Maintainers Without Escalation Plan
...
### 15. Drive-By PRs Without Claiming the Issue First
...
### 16. Touching Infrastructure Maintainers Want to Own
...
### 16. Broken Diffs from Botched Rebases
...
### 17. Enterprise/License-Sensitive Areas Are Off-Limits
...
### 18. Design Correctness > CI Status for Core Infrastructure
...
### 19. Structured Change Tables for Mechanical Refactors
...
### 20. Use Non-Closing Issue Links for Series Work
...
### 21. Split Mechanical Series by Review Unit, Not by Narrative
...
### 22. Simpler Fix Wins When Competing PRs Exist
...
### 23. Quantitative Metrics in Performance PR Descriptions
...
### 24. Hiding a Feature Branch Under a Bug-Fix Title
...
### 58. Maintainer Takeover Is a Positive Outcome
...
### 59. Scope Is a Queue-Time Multiplier in Bandwidth-Constrained Repos
...
### 60. Cite Analogous Existing Code for Instant Credibility
...
### 61. Real Tests Over Mocked Tests
...
### 62. Production Validation from Community Accelerates Merge
...
### 63. Scope Expansion Through Review Is a Time Trap
...
### 65. AI Submissions Require Human Supervision During Compliance Windows
...
### 66. Study Existing Integration Patterns Before Adding New Ones
...
### 64. Sign the CLA Before Opening the PR
...
### 72. Signal Refactor Safety with [no-op] Tags
...
### 74. Approval ≠ Merge: Follow Up After 3-5 Days
...
### 70. Target Maintainer-Neglected Areas for Fast-Track Merges
...
### 71. Use the Project's Preferred Communication Channel for Follow-Up
...
### 75. Cross-Reviewer Coordination with "LGTM with Hold"
...
### 76. Self-Imposed Hold with Documented Verification
...
### 77. Causal Chain in First Paragraph for Regression Fixes
...
### 78. Document CI Retests with Classification
...
### 79. Performance Awareness and Cache Safety in Subsystem Changes
...
### 80. Fork-Master Contamination Kills PRs Instantly
...
### 81. Adopt Reviewer Design Suggestions — They Improve Outcomes
...
### 82. Second Attempts Win When First Attempts Teach
...
### 83. Naive Mechanical Changes Without Verification Are Reputationally Toxic
...
### 84. AI Co-Author Trailers Break CLA Gates
...
### 85. Self-Correction and Refiling Is a Valid Contributor Pattern
...
### 86. Codecov Patch Coverage 0% Is a Red Flag Even When Tests Pass
...
### 87. Follow-Up Fix PRs Build Trust Faster Than New Features
...
### 88. Unsolicited Infrastructure PRs Are Dead on Arrival
...
### 89. Resolve CHANGES_REQUESTED Before Merge — Or Face a Revert
...
### 90. Clear the Bot Round Before Humans Engage
...
### 91. Separate Public API Response Shapes from Internal Types
...
### 92. Issue Invitation Is Not an Open Call
...
### 93. Match Fix Complexity to Problem Complexity
...
### 94. "Right Fix, Wrong Layer" — Confirm the Fix Belongs Here
...
### 95. Empirical Data in PR Descriptions Collapses Review Time
...
### 96. Proactively Ping Reviewers After Queue Timeout
...
### 97. Don't Spray-Submit Multiple Similar PRs Simultaneously
...
### 98. Use Review Bots as Interactive Pair Programmers
...
### 99. Bundle Docs-Only Changes with Code Changes in High-Volume Repos
...
### 100. The Two-Ping Rule — Set a PR Budget Before You Start
...
### 101. Bot Approval Is Not Design Approval
